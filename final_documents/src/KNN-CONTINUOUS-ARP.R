...
# remove all columns except the 4 we are using
...
# min-max normalize the columns we are using
...
library(DMwR)
# create the formula that contains which variables to use as predictors
