...
# normalize the 3 predictor variables we use
...
# the name of the attack we are predicting
...
# rename the attack type and normal class from strings to 0/1
...
# run smote to perform synthetic over sampling
train_smote<-SMOTE(f,train,perc.over=90,perc.under=400,k=1)
View(train_smote)
library(mlr)
